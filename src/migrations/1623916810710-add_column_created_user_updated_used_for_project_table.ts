...
export class addColumnCreatedUserUpdatedUserForProjectTable1623916810710 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`alter table "project" drop column created_user, updated_user`)
    }
